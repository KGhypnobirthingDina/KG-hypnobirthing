...
export default function SideBarSmall() {
    ...
    return (
        <div className={styles.container}>
            ...
            {options && (
                <ul> {/* Added className for styling */}
                 <Link to="/Refund">
                        <li className={activeBar === "/Refund" ? styles.active : ""}>החזר כספי</li>
                    </Link>
                    ...
                    <Link to="/QuestionsAndAnswers">
                        <li className={activeBar === "/QuestionsAndAnswers" ? styles.active : ""}>שאלות שכיחות</li>
                    </Link>
                    <Link to="/Articles">
                        <li className={activeBar === "/Articles" ? styles.active : ""}>מאמרים</li>
                    </Link>
                    <Link to="/recommendations">
                        <li className={activeBar === "/recommendations" ? styles.active : ""}>המלצות</li>
                    </Link>
                    <Link to="/contact">
                        <li className={activeBar === "/contact" ? styles.active : ""}>צור קשר</li>
                    </Link>
                    <Link to="/calendar">
